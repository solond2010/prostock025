            ...
            <table className="w-full text-sm min-w-[480px]">
              <thead>
                <tr className="border-b border-border/40 bg-muted/10">
                  <th className="text-left px-4 py-2.5 text-xs font-semibold text-muted-foreground uppercase tracking-wide whitespace-nowrap">Fecha</th>
                  ...
                  <th className="text-right px-4 py-2.5 text-xs font-semibold text-muted-foreground uppercase tracking-wide whitespace-nowrap">Coste</th>
                  <th className="w-[52px]" />
                </tr>
              </thead>
              <tbody>
                {gastosFiltrados.map(g => (
                  <tr key={g.id} className="table-row-premium">
                    ...
                    <td className="px-4 py-3">
                      <span className="inline-flex items-center h-5 px-1.5 rounded-md text-[10px] font-semibold border border-border/50 bg-muted/40 text-muted-foreground whitespace-nowrap">
                        {g.categoria}
                      </span>
                    </td>
                    <td className="px-4 py-3 text-right font-semibold text-destructive tabular-nums whitespace-nowrap">
