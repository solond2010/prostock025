    ...
    <aside className="hidden lg:flex w-56 xl:w-60 shrink-0 flex-col min-h-dvh sticky top-0 h-dvh overflow-y-auto pt-safe pl-safe bg-[hsl(var(--sidebar-background))] border-r border-[hsl(var(--sidebar-border))]">
      ...
      <div className="px-2.5 pt-3">
        <button
          ...
          className="w-full flex items-center gap-2 rounded-xl border border-border/60 bg-muted/30 px-3 py-2 text-[12px] text-muted-foreground/70 hover:bg-muted/60 hover:text-foreground transition-colors"
        >
          <Search className="h-3.5 w-3.5" />
          <span className="flex-1 text-left">Buscar…</span>
          <kbd className="text-[9px] font-semibold bg-background border border-border/60 rounded px-1 py-0.5">⌘K</kbd>
        </button>
      </div>
